...
const translations = {
  fr: {
    ...
    heroTitle: 'Le <span class="highlight-word">sourire</span> <span class="keep-together">en un clic.</span>',
    heroText:
      "Retrouvez plusieurs boutiques au même endroit, commandez vos articles et faites-vous livrer avec un service qui vérifie la qualité avant expédition.",
    viewCatalog: "Voir le catalogue WhatsApp",
    exploreItems: "Explorer les articles",
    verifiedIncluded: "Vérification incluse",
    beforeDelivery: "Avant livraison",
    popularStores: "Boutiques populaires",
    categoriesTitle: "Commandez tout au même endroit",
    openFullCatalog: "Ouvrir le catalogue complet",
    catAll: "Tout",
    catAllDesc: "Sélection Kiintrus",
    catBeauty: "Beauté",
    catBeautyDesc: "Soins visage, crèmes, gels",
    catFashion: "Mode & wax",
    catFashionDesc: "Tissus, ensembles, enfants",
    catHome: "Maison",
    catHomeDesc: "Coussins et déco",
    catBooks: "Librairie",
    catBooksDesc: "Romans et précommandes",
    catAccessories: "Accessoires",
    catAccessoriesDesc: "Selfie, gadgets utiles",
    catalog: "Catalogue",
    featuredItems: "Tout",
    heroPrev: "Faire défiler à gauche",
    heroNext: "Faire défiler à droite",
    itemsLabel: "articles",
    securePayment: "Paiement sécurisé",
    securePaymentText: "Un parcours simple et rassurant.",
    reliableDelivery: "Livraison fiable",
    reliableDeliveryText: "Suivi clair jusqu'à réception.",
    verifiedQuality: "Qualité vérifiée",
    verifiedQualityText: "Les articles sont contrôlés avant départ.",
    howItWorks: "Comment ça marche",
    deliveryTitle: "Du catalogue WhatsApp à votre porte.",
    deliveryText:
      "Kiintrus rassemble des boutiques partenaires, facilite la commande et prend soin de l'étape sensible : vérifier que l'article correspond avant de vous le livrer.",
    ...
    stepReceive: "Recevez",
    stepReceiveText: "L'article est vérifié, emballé, puis livré rapidement.",
    cart: "Panier",
    ...
    productDetails: "Détails article",
    ...
    footerText: "Plateforme de commerce en ligne, boutiques partenaires, vérification qualité et livraison.",
    services: "Services",
    onlineOrder: "Commande en ligne",
    preDeliveryCheck: "Vérification avant livraison",
...
let products = [
  {
    ...
    price: "6 000 F CFA",
    description: "Votre crème solaire DR RASHEL.",
    tag: "Soin",
    image: "assets/products/dr-rasheel-solaire.jpg",
    imageAlt: "Crème solaire DR Rasheel",
  ...
  },
  {
    ...
    store: "Efia's Garden Boutique",
    price: "13 000 F CFA",
    description: "Gel nettoyant : exfoliant, anti-tache, réduit les cernes.",
    tag: "Soin",
  ...
  {
    id: 3,
    name: "Crème visage jour AIKEN",
    category: "beaute",
    store: "Efia's Garden Boutique",
    price: "15 000 F CFA",
    description: "Crème visage jour : réduit les taches, les boutons et illumine.",
    tag: "Soin",
    image: "assets/products/aiken-jour.jpg",
    imageAlt: "Crème visage jour AIKEN",
  ...
  },
  {
    ...
    description: "Disponible en précommande uniquement.",
    tag: "Livre",
  ...
  },
  {
    ...
    price: "3 000 F CFA",
    description: "Tige pour poser son téléphone et prendre des photos.",
    tag: "Accessoire",
  ...
  },
  {
    ...
    price: "2 500 F CFA",
    description: "Ensemble pour fille de 3 mois à 2 ans.",
    tag: "Enfant",
  ...
  },
  {
    ...
    store: "NINOSWEET BOUTIQUE (Enfants)",
    price: "2 500 F CFA",
    description: "Ensemble pour fille de 3 mois à 3 ans. Tailles disponibles.",
    tag: "Enfant",
  ...
  {
    id: 8,
    name: "SHORT + TSHIRT GARÇON (NINOSWEET)",
    category: "mode",
    store: "NINOSWEET BOUTIQUE (Enfants)",
    price: "2 500 F CFA",
    description: "Ensemble garçon de 2 mois à 3 ans. Tailles disponibles.",
    tag: "Enfant",
    image: "assets/products/ninosweet-garcon.jpg",
    imageAlt: "Short et tshirt garçon Ninosweet",
  ...
  },
  {
    ...
    price: "15 000 F CFA",
    description: "Imitation des imprimés du Grand Super.",
    tag: "Wax",
  ...
  },
  {
    ...
    imageAlt: "Tissu imitation Grand Super coloré",
  ...
  {
    id: 12,
    name: "Coussins de décoration pour fauteuil",
    category: "maison",
    store: "Smaat Trade Boutique",
    price: "2 000 F CFA",
    description: "Coussins décoration fauteuil. Dimensions : 30/30 cm.",
    tag: "Maison",
    image: "assets/products/coussins-fauteuil.jpg",
    imageAlt: "Coussins de décoration pour fauteuil",
  ...
  {
    id: 14,
    name: "COMPLÉMENTS ALIMENTAIRES PRINCESS",
    category: "beaute",
    store: "All items",
    price: "20 000 F CFA",
    description: "Compléments alimentaires pour raffermir le corps.",
    tag: "Bien-être",
    image: "assets/products/princess-complements.jpg",
    imageAlt: "Compléments alimentaires Princess",
  ...
  },
  {
    ...
    store: "All items",
    price: "12 000 F CFA",
    description: "Mousse nettoyante pour peau acnéique et sensible.",
    tag: "Soin",
  ...
  },
  {
    ...
    store: "All items",
    price: "10 000 F CFA",
    description: "Peau abîmée, anti-âge, illumine le contour des yeux.",
    tag: "Soin",
    image: "assets/products/creme-anti-cernes.jpg",
    imageAlt: "Crème anti-cernes",
  ...
  },
  {
    ...
    store: "All items",
    price: "13 000 F CFA",
    description: "Toner : tonifie la peau, régénère et illumine.",
    tag: "Soin",
  ...
  {
    id: 21,
    name: "Crème visage (nuit) ALIA",
    category: "beaute",
    store: "All items",
    price: "15 000 F CFA",
    description: "Crème visage nuit : hydratante, éclaircissante.",
    tag: "Soin",
    image: "assets/products/creme-nuit-alia.jpg",
    imageAlt: "Crème visage nuit ALIA",
    colors: ["#ffd8dc", "#fff3e8"],
    icon: "beauty",
  },
  {
    id: 22,
    name: "Crème visage AIKEN",
    category: "beaute",
    store: "All items",
    price: "13 000 F CFA",
    description: "Crème visage : éclat, protection et cicatrisation.",
    tag: "Soin",
    image: "assets/products/creme-visage-aiken.jpg",
    imageAlt: "Crème visage AIKEN",
    colors: ["#dff3ff", "#fff8c7"],
    icon: "beauty",
  },
  {
    id: 23,
    name: "Crème solaire AIKEN",
    category: "beaute",
    store: "All items",
    price: "13 000 F CFA",
    description: "Crème solaire : éclat et protection.",
    tag: "Soin",
    image: "assets/products/creme-solaire-aiken.jpg",
    imageAlt: "Crème solaire AIKEN",
    colors: ["#fff8c7", "#eef7ff"],
    icon: "beauty",
  },
  {
    id: 24,
    name: "Crème visage (nuit) SAFI",
    category: "beaute",
    store: "All items",
    price: "15 000 F CFA",
    description: "Crème visage nuit : éclaircit le teint, exfolie le visage.",
    tag: "Soin",
    image: "assets/products/creme-nuit-safi.jpg",
    imageAlt: "Crème visage nuit SAFI",
...
function orderUrl(product) {
  const text = product
    ...
    : currentLanguage === "en"
      ...
      : `Bonjour Kiintrus, je souhaite commander les articles de ma sélection.`;
            ...
            ${
              gallery.length
                ? `<img class="product-card-image" src="${escapeHtml(gallery[0])}" alt="${escapeHtml(product.imageAlt || product.name)}" data-images="${escapeHtml(gallery.join("|"))}" data-image-index="0" />
                  ${
                    gallery.length > 1
                      ? `<button class="product-image-arrow product-image-arrow-prev" type="button" aria-label="Image précédente" data-image-step="-1" data-stop-card>
